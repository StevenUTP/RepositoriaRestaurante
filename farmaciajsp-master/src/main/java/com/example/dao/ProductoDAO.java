...
public class ProductoDAO {
    ...
    private static final String INSERT_PRODUCTO_SQL = "INSERT INTO producto (nombre, precio) VALUES (?, ?)";
    private static final String SELECT_PRODUCTO_BY_ID = "SELECT id, nombre, precio FROM producto WHERE id = ?";
    ...
    private static final String UPDATE_PRODUCTO_SQL = "UPDATE producto SET nombre = ?, precio = ? WHERE id = ?";
