...
public class ProductoServlet extends HttpServlet {
    ...
    private void insertarProducto(HttpServletRequest request, HttpServletResponse response)
        ...
        Producto nuevoProducto = new Producto(null, nombre, precio); // Crea un nuevo objeto Producto
    ...
    private void actualizarProducto(HttpServletRequest request, HttpServletResponse response)
        ...
        String nombre = request.getParameter("nombre");
        double precio = Double.parseDouble(request.getParameter("precio"));
        Producto producto = new Producto(id, nombre, precio); // Crea un objeto Producto con los nuevos valores
    ...
    public static class InsertarProductoServlet extends HttpServlet {
        ...
        private void insertarProducto(HttpServletRequest request, HttpServletResponse response)
            ...
            String nombre = request.getParameter("nombre");
            double precio = Double.parseDouble(request.getParameter("precio"));
            Producto nuevoProducto = new Producto(null, nombre, precio);
