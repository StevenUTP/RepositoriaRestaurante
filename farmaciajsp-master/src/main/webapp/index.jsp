...
<head>
    ...
    <!-- Título de la página -->
    <title>Restaurante - Página Principal</title>
...
<div class="container mt-5">
    ...
    <h1 class="mb-4">Bienvenido al Restaurante</h1>
    ...
    <div class="list-group">
        ...
        -->
        <a href="productos" class="list-group-item list-group-item-action">Gestionar Menú</a>
        <!--
